  ...
  return (
    <div className='m-2'>
      <div
        ...
        onClick={() =>  navigate(`/pins-detail/${_id}`)}
              ...
              <div className='flex justify-between items-center gap-2 w-full'>
                {destination && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className='bg-white flex items-center gap-2 text-black font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hovere:shadow-md'
                  >
                ...
                {postedBy?._id === user?.sub && (
                  ...
                  className="bg-white p-2 opacity-70 hover:opacity-100 font-bold text-dark text-base rounded-full"
                  >
                    <AiTwotoneDelete/>
